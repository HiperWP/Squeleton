...
[![Version](https://img.shields.io/badge/version-4.1.9-blue.svg)](https://squeleton.dev/)
    ...
    <div class="row gap-15">
      <div class="c-xs-12 c-sm-9 c-md-6 c-center">
        <div class="f-grid f-items-center f-justify-center">
          ...
          <div class="fs-3 m-10-l p-5-lr border-rd-4 border-all animated magnetIn delay-800">v4.1.9</div>
        </div>
